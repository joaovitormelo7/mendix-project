package externaldatabaseconnector.impl.service;
...
public class MendixObjectService {
    ...
    public List<IMendixObject> createMendixObjects(final IContext context,
                                                   final IMetaObject metaObject, List<Map<String, Optional<Object>>> resultSet, IMetaAssociation callableResultSetAssociation, IMendixObject callableMainEntityMendixObject) throws DatabaseConnectorException {
    ...
    private IMendixObject createMendixObject(final IContext context,
                                            final IMetaObject metaObject, Map<String, Optional<Object>> columns, IMetaAssociation callableResultSetAssociation, IMendixObject callableMainEntityMendixObject) throws DatabaseConnectorException {
    ...
    public void setMemberValue(IContext context, IMetaObject metaObject, IMendixObject obj, String name, Optional<Object> value) throws DatabaseConnectorException {
