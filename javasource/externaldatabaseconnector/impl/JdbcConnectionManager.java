...
import externaldatabaseconnector.impl.dbsource.factory.DataSourceStrategyFactory;
...
public class JdbcConnectionManager implements ConnectionManager {
	...
	public Connection getConnection(ConnectionDetail connectionDetailsObject)
		...
		final HikariDataSource dataSource = connectionPool.computeIfAbsent(connPoolKey, k -> {
			...
			try {
				return DataSourceStrategyFactory.createHikariDataSource(connectionDetailsObject, connPoolKey);
			} catch (Exception e) {
