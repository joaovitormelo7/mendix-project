...
public class MxSSLFactory extends SSLSocketFactory {
  ...
  public MxSSLFactory(Properties properties) throws Exception {
    ICertificateInfo certificateInfo =
        CertificateUtil.getClientCertificateInfo(properties.getProperty(DataSourceConstants.CLIENT_CERTIFICATE_IDENTIFIER));
    ...
    if (certificateInfo != null) {
      ...
      KeyStore keyStore = KeyStore.getInstance(DataSourceConstants.PKCS12);
    ...
    var context = SSLContext.getInstance(DataSourceConstants.TLS_PROTOCOL);
